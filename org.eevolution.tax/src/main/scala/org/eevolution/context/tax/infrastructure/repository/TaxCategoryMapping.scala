...
trait TaxCategoryMapping {
	implicit val TaxCategorySchemaMeta : context.SchemaMeta[TaxCategory] = 
			schemaMeta[TaxCategory] ("C_TaxCategory",
				_.clientId -> "AD_Client_ID",
				_.orgId -> "AD_Org_ID",
				_.taxCategoryId -> "C_TaxCategory_ID",
				_.commodityCode -> "CommodityCode",
				_.created -> "Created",
