...
case class TaxBase(
				...
				base : Option[ListType], // Base
				taxBaseId : Id, // C_TaxBase_ID
				...
				name : String, // Name
				percentage : Option[Number], // Percentage
...
with Traceable {
	...
	override val entityName: String = "C_TaxBase"
	override val identifier: String = "C_TaxBase_ID"
	override val Id: Id = taxBaseId
}
