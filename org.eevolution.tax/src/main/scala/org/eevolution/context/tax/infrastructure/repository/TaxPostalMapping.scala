...
trait TaxPostalMapping {
	implicit val TaxPostalSchemaMeta : context.SchemaMeta[TaxPostal] = 
			schemaMeta[TaxPostal] ("C_TaxPostal",
				_.clientId -> "AD_Client_ID",
				_.orgId -> "AD_Org_ID",
				_.taxPostalId -> "C_TaxPostal_ID",
				_.taxId -> "C_Tax_ID",
				_.created -> "Created",
				_.createdBy -> "CreatedBy",
				_.isActive -> "IsActive",
				_.postal -> "Postal",
				_.postalTo -> "Postal_To",
				_.uuid -> "UUID",
				_.updated -> "Updated",
