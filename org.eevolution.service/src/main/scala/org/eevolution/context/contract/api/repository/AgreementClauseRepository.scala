...
object AgreementClauseRepository {

	type AgreementClauseRepository = Has[AgreementClauseRepository.Service]
	...
	def getByAgreementClauseId(agreementClauseId: Id): RIO[AgreementClauseRepository, Option[AgreementClause]]
	= RIO.accessM(_.get.getByAgreementClauseId(agreementClauseId))

	def getByAgreementClauseCategoryId(agreementClauseCategoryId: TableDirect): RIO[AgreementClauseRepository,List[AgreementClause]]
	= RIO.accessM(_.get.getByAgreementClauseCategoryId(agreementClauseCategoryId))

	def getByDescription(description: Option[String]): RIO[AgreementClauseRepository,List[AgreementClause]]
	= RIO.accessM(_.get.getByDescription(description))

	def getByName(name: String): RIO[AgreementClauseRepository, Option[AgreementClause]]
	= RIO.accessM(_.get.getByName(name))

	def getByValue(value: Option[String]): RIO[AgreementClauseRepository, Option[AgreementClause]]
	= RIO.accessM(_.get.getByValue(value))

	def getAll: RIO[AgreementClauseRepository,List[AgreementClause]]
	= RIO.accessM(_.get.getAll)

	def getAll(clientId: TableDirect): RIO[AgreementClauseRepository,List[AgreementClause]]
