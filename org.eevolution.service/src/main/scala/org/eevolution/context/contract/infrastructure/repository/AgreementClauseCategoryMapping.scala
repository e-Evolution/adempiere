...
import org.eevolution.context.contract.domain.model.AgreementClauseCategory
...
trait AgreementClauseCategoryMapping {

  implicit val AgreementClauseCategorySchemaMeta: context.SchemaMeta[AgreementClauseCategory] =
    schemaMeta[AgreementClauseCategory]("S_AgreementClauseCategory",
      ...
      _.isActive -> "IsActive",
      _.name -> "Name",
      _.agreementClauseCategoryId -> "S_AgreementClauseCategory_ID",
      _.uuid -> "UUID",
      _.updated -> "Updated",
