package org.eevolution.context.contract.domain.validation
...
class CalloutContract extends CalloutEngine {
  ...
  def partner(context: Properties, windowNo: Int, gridTab: GridTab, gridField: GridField, value: Object): String = {
    ...
    if (partnerBillLocations.nonEmpty) {
    ...
    if (partnerShipLocations.nonEmpty) {
  ...
  def partnerBill(context: Properties, windowNo: Int, gridTab: GridTab, gridField: GridField, value: Object): String = {
    val contract = GridTabWrapper.create(gridTab, classOf[I_S_Contract])
    if (isCalloutActive)
      return ""
  ...
  def duration(context: Properties, windowNo: Int, gridTab: GridTab, gridField: GridField, value: Object): String = {
    if (isCalloutActive || value == null)
      return ""
