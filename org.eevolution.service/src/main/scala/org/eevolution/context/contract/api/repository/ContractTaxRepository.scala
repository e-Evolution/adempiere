...
object ContractTaxRepository {

	type ContractTaxRepository = Has[ContractTaxRepository.Service]
	...
	def getByContractId(contractId: TableDirect): RIO[ContractTaxRepository,List[ContractTax]]
	= RIO.accessM(_.get.getByContractId(contractId))

	def getByContractTaxId(contractTaxId: Id): RIO[ContractTaxRepository, Option[ContractTax]]
	= RIO.accessM(_.get.getByContractTaxId(contractTaxId))

	def getAll: RIO[ContractTaxRepository,List[ContractTax]]
	= RIO.accessM(_.get.getAll)

	def getAll(clientId: TableDirect): RIO[ContractTaxRepository,List[ContractTax]]
