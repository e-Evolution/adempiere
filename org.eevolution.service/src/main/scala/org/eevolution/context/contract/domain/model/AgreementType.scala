...
case class AgreementType(
				...
				name : String, // Name
				agreementTypeId : Id, // S_AgreementType_ID
...
with Traceable {
	...
	override val entityName: String = "S_AgreementType"
	override val identifier: String = "S_AgreementType_ID"
	override val Id: Id = agreementTypeId
}
