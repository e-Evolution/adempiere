...
trait ContractPartiesMapping {
	implicit val ContractPartiesSchemaMeta : context.SchemaMeta[ContractParties] = 
			schemaMeta[ContractParties] ("S_ContractParties",
				...
				_.contractPartiesId -> "S_ContractParties_ID",
