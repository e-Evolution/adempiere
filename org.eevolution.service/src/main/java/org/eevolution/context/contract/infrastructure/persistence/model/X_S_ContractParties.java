...
public class X_S_ContractParties extends PO implements I_S_ContractParties, I_Persistent 
{
	...
	public org.eevolution.context.contract.infrastructure.persistence.model.I_S_ContractPartiesType getS_ContractPartiesType() throws RuntimeException
    {
		return (org.eevolution.context.contract.infrastructure.persistence.model.I_S_ContractPartiesType)MTable.get(getCtx(), org.eevolution.context.contract.infrastructure.persistence.model.I_S_ContractPartiesType.Table_Name)
