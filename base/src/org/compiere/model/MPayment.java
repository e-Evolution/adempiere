	...
	implements DocAction, DocumentReversalEnabled, ProcessCall
{
	...
	public BigDecimal getAllocatedAmt ()
	{
		...
		String sql = "SELECT SUM(currencyConvert(al.Amount,"
			...
			+ " AND ah.IsActive='Y' AND al.IsActive='Y'"; //Should be include Allocation with any document status to allow processing direct allocation of payment with invoice
