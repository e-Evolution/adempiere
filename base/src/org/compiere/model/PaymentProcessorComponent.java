...
/**
 * API Payment Processor Component
 */
public interface PaymentProcessorComponent {

    public static PaymentProcessor create(X_C_PaymentProcessor paymentProcessor, X_C_Payment payment) {
        return null;
    }

    public abstract boolean processCreditCard() throws IllegalArgumentException;

    public abstract boolean processCC() throws IllegalArgumentException;

    public abstract boolean paymentProcessedSuccessfully();
