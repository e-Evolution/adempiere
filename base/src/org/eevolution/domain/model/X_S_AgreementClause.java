...
public class X_S_AgreementClause extends PO implements I_S_AgreementClause, I_Persistent 
{
    ...
    {
		return (org.eevolution.domain.model.I_S_AgreementClauseCategory)MTable.get(getCtx(), org.eevolution.domain.model.I_S_AgreementClauseCategory.Table_Name)
    ...
    {
		return (org.eevolution.domain.model.I_S_AgreementType)MTable.get(getCtx(), org.eevolution.domain.model.I_S_AgreementType.Table_Name)
