...
public class X_S_ContractTermConditionLine extends PO implements I_S_ContractTermConditionLine, I_Persistent 
{
    ...
    {
		return (org.eevolution.domain.model.I_S_AgreementClause)MTable.get(getCtx(), org.eevolution.domain.model.I_S_AgreementClause.Table_Name)
    ...
    {
		return (org.eevolution.domain.model.I_S_ContractTermCondition)MTable.get(getCtx(), org.eevolution.domain.model.I_S_ContractTermCondition.Table_Name)
